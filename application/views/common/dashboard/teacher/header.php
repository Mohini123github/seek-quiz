                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <form class="navbar-form navbar-right" role="form">
                          <a href="<?php echo base_url('welcome/plan');?>" class="btn btn-primary"
                            type="submit">Upragde Now</a>
                          ...
                          <a href="<?php echo base_url('index.php/LogOut/logout') ?>" style="text-decoration:none;"><i
                              class="fa-solid fa-right-from-bracket fs-4 ms-1   text-secondary"></i><span
                              class="text-secondary fs-5 ms-1">Logout</span></a>
